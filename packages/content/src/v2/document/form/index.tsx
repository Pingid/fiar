...
import { usePageStatusAsyncHandler } from '@fiar/workbench/v2'

import { getCollectionRef, getDocumentRef, useDocumentData, useDocumentRef, useFirestore } from '../../lib/index.js'
